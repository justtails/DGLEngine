...
glGetColorTableParameterfvEXT := nil;
  ...
  //FBO
  glGenRenderbuffersEXT := nil;
  glDeleteRenderbuffersEXT := nil;
  glBindRenderbufferEXT := nil;
  glRenderbufferStorageEXT:= nil;
  glGenFramebuffersEXT := nil;
  glDeleteFramebuffersEXT:= nil;
  glBindFramebufferEXT:= nil;
  glFramebufferTexture2DEXT := nil;
  glFramebufferRenderbufferEXT := nil;
  glCheckFramebufferStatusEXT:= nil;
